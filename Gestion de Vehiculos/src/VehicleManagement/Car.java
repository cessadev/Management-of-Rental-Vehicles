...
public class Car extends Vehicle {
    public Car(String brand, String model, String color, int ageManufacture, int passengerCapacity) {
    ...
    public float rentalCost(LocalDate rentalStartDate, LocalDate rentalEndDate) {
        ...
        float carCost = 50.0f;
        float totalCost = carCost * ChronoUnit.DAYS.between(rentalStartDate, rentalEndDate);
        return totalCost;
    }
